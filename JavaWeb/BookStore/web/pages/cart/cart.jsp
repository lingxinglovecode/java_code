	...
	<script type="text/javascript">
		$(function () {
			...
			$(".updateCount").change(function () {
				...
				if(confirm("你确定要将《"+name+"》数量修改为"+value+"么？")){
					//发起请求给服务器保存修改
					location.href = "http://localhost:8080/BookStore/cartServlet?action=updateCount&count="+value+"&id="+id;
				}else {
